  ...
  return (
    <div className="min-h-screen bg-blue-50 flex items-center justify-center px-4 py-8">
      <div className="bg-white rounded-3xl shadow-xl p-6 w-full max-w-sm">
        ...
        {/* Google Login (รอเชื่อม Supabase OAuth จริงในอนาคต) */}
        <button
          disabled
          className="w-full flex items-center justify-center gap-3 border-2 border-gray-200 rounded-xl py-3 px-4 opacity-40 cursor-not-allowed"
        >
          ...
          <span className="font-medium text-gray-500">เข้าสู่ระบบด้วย Google (เร็วๆ นี้)</span>
        </button>
