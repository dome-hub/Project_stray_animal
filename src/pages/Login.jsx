...
export default function Login({ onLogin }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-indigo-100 flex items-center justify-center px-6">
      <div className="bg-white rounded-3xl shadow-xl p-8 w-full max-w-sm">
        ...
        <button
          ...
          disabled={loading}
          className="w-full flex items-center justify-center gap-3 border-2 border-gray-200 rounded-xl py-3 px-4 hover:bg-gray-50 active:bg-gray-100 transition-all duration-200 disabled:opacity-60"
        >
          {loading ? (
