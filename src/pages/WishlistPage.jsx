...
// ข้อมูลจำลอง สัตว์ที่ผู้ใช้กดบันทึกไว้
const สัตว์ที่บันทึก = [
  { id: 1, emoji: '🐕', ชื่อ: 'มะม่วง', สายพันธุ์: 'สุนัขพันธุ์ไทยผสม', อายุ: '2 ปี', เพศ: 'ตัวผู้', นิสัย: ['เป็นมิตร', 'ขี้เล่น'], สถานที่: 'ลาดพร้าว กรุงเทพฯ', คะแนน: 95 },
  { id: 2, emoji: '🐈', ชื่อ: 'ส้ม', สายพันธุ์: 'แมวส้ม', อายุ: '1 ปี', เพศ: 'ตัวเมีย', นิสัย: ['เป็นมิตร', 'สงบเสงี่ยม'], สถานที่: 'บางนา กรุงเทพฯ', คะแนน: 88 },
]

function WishlistPage() {
  const navigate = useNavigate()

  // เก็บรายการสัตว์ที่บันทึกไว้ (สามารถลบออกได้)
  const [รายการ, setรายการ] = useState(สัตว์ที่บันทึก)
